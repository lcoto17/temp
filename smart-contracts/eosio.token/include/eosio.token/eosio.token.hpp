...
namespace eosio {
   ...
   class [[eosio::contract("eosio.token")]] token : public contract {
      public:
          ...
          * @param to - the account to be transferred to,
          * @param quantity - the quantity of tokens to be transferred,
          * @param productionarea - the production area string source application.
          * @param productionareaunit - the production area unit string source application.
          * @param userid - the user id string source application.
          * @param createddate - the createddate string in milliseconds from source application.
          */
         [[eosio::action]]
         void evaluation( const name&  from,
                        const name&    to, 
                        const asset&   quantity,
                        const string&  productionarea,
                        const string&  productionareaunit, 
                        const string&  userid, 
                        const string&  createddate);
          ...
          * @param to - the account to be transferred to,
          * @param quantity - the quantity of tokens to be transferred,
          * @param sellerName - the seller transaction.
          * @param soldVolume - the sold volume (Seller info).
          * @param soldVolumeUnit - the sold volume unit (Seller info).
          * @param soldLocalAmount - the sold local amount (Seller info).
          * @param soldDolarAmount - the sold dolar amount (Seller info).
          * @param purchaserName - the purchaser name.
          * @param purchasedVolume - the purchased volume (Purchaser info).
          * @param purchasedVolumeUnit -  the purchased volume (Purchaser info).
          * @param localPurchasedAmount - the purchased local amount (Purchaser info).
          * @param dolarPurchasedAmount - the purchased dolar amount (Purchaser info).
          * @param userid - the user id string source application.
          * @param createddate - the createddate string in milliseconds from source application.
          */
         [[eosio::action]]
         void trade( const name& from,
                  const name&    to,
                  const asset&   quantity,
                  const string&  sellername,
                  const string&   soldvolume,
                  const string&  soldvolumeunit,
                  const string&   localsoldamount,
                  const string&   dolarsoldamount,
                  const string&  purchasername,
                  const string&   purchasedvolume,
                  const string&  purchasedvolumeunit,
                  const string&   localpurchasedamount,
                  const string&   dolarpurchasedamount,
                  const string&  userid, 
                  const string&  createddate);
